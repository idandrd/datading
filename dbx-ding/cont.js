(() => {
  ...
  function scan() {
    ...
    if (Object.keys(ids).length !== 0) {
      ...
      [...document.getElementsByClassName(CELL_CLASS)].map((cell) => {
        const hasDingFlag = [
  ...
  function burnIds() {
    [...document.getElementsByClassName(RESULTS_CLASS)].map((resultStats) => {
      ids[md5(resultStats.textContent)] = true;
    });
  }
